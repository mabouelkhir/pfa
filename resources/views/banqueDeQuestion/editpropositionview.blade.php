    ...
    <div class="alert alert-dismissible alert-info">
       ...
       <div class="col-md-6 text-center mt-2 " style="margin: auto;">
        <label for="description" class="form-label mt-4"><h6>QCM DESCRIPTION :</h6></label>
         <input type="text" class="form-control text-center center ml-5" value="{{$proposition->qcm->description}}" name="description" disabled>
      </div>
      ...
      <div class="col-md-6 text-center mt-2 " style="margin: auto;">
         <div class="form-group">
             <label for="exampleTextarea" class="form-label mt-4"><h6>Amorce :</h6></label>
             <textarea class="form-control" id="exampleTextarea" rows="3"  name="amorce" disabled>{{$proposition->qcm->amorce}}</textarea>
         </div>
